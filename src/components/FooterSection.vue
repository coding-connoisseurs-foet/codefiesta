        ...
        <div class="main-footer">
            <div class="social">
                <div class="about">
                    ...
                    <p>We are Coding Coding Connoisseurs. We aim to build a close knit community of coding enthusiasts to a
                        better network, opportunities, discussions and mentorship. The aim of the club is to improve the
                        overall programming culture at FoET-LU.</p>
                ...
                <div class="media">
                    ...
                    <ul class="social-links">
                        <li v-for="(n, i) in social" :key="i">
                            <a :href="n.link" target="_blank"> <img :src="n.logo">
                                <p>{{ n.handle }}</p>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="venue">
                ...
                <iframe
                    ...
                    width="300" height="200" id="map" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                <p>FoET, University of Lucknow Second campus</p>
            </div>
        </div>
        <p class="slogan">🚩 Jai CC 🚩</p>
    </div>
</template>
